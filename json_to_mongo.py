...
def transform():
    ...
    with open("C:/Users/marti/Documents/SpartaDocs/Git2_0/Git_Sparta_BaseDirectory/Mongo/pilots_2.json") as jsonfile:
...
'''
    ...
    print(len(link_name_dict))

    return link_name_dict 

    
    #with open('C:/Users/marti/Documents/SpartaDocs/Git2_0/Git_Sparta_BaseDirectory/Mongo/transform.json', "w") as jsonfile:
        #json.dump(link_name_dict, jsonfile)
'''